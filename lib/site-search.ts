...
const BASE_ITEMS: SiteSearchItem[] = [
	...
	{
		title: 'Оздоровчі масажі в Поляні — порівняння та карта',
		href: '/cat/spa-bani-chany/masazhi',
		keywords: ['масаж', 'масажі', 'SPA масаж', 'оздоровлення Поляна', 'релакс Карпати', 'Закарпаття'],
		section: 'SPA та відпочинок',
	},
	{
		title: 'Фітобочки в Поляні — порівняння та карта',
		href: '/cat/spa-bani-chany/fitobochky',
		keywords: ['фітобочка', 'фітобочки', 'фіто пара', 'оздоровлення Поляна', 'SPA бочка', 'Закарпаття'],
		section: 'SPA та відпочинок',
	},
]
...
export function getSearchDirectHref(rawQuery: string): string | null {
	...
	const substringRules: { needle: string; href: string }[] = [
		...
		{ needle: 'масаж поляна', href: '/cat/spa-bani-chany/masazhi' },
		{ needle: 'масажі поляна', href: '/cat/spa-bani-chany/masazhi' },
		{ needle: 'масаж у поляні', href: '/cat/spa-bani-chany/masazhi' },
		{ needle: 'фітобочка поляна', href: '/cat/spa-bani-chany/fitobochky' },
		{ needle: 'фітобочки поляна', href: '/cat/spa-bani-chany/fitobochky' },
		{ needle: 'фітобочки в поляні', href: '/cat/spa-bani-chany/fitobochky' },
	...
	if (sig.length === 1) {
		...
		const one: Record<string, string> = {
			...
			фітобочка: '/cat/spa-bani-chany/fitobochky',
			фітобочки: '/cat/spa-bani-chany/fitobochky',
			басейн: '/cat/spa-bani-chany/baseni',
			басейни: '/cat/spa-bani-chany/baseni',
			масаж: '/cat/spa-bani-chany/masazhi',
			масажі: '/cat/spa-bani-chany/masazhi',
