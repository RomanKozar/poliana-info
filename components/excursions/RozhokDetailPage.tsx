...
import RozhokRouteMap from '@/components/excursions/RozhokRouteMap'
import {
...
export default function RozhokDetailPage() {
	return (
		<RozhokPhotoGalleryProvider images={ROZHOK_PHOTOS}>
			<div className='flex min-h-0 w-full flex-col bg-[#F5F6F7] pb-3 sm:pb-12'>
					...
					<div className='grid items-start gap-8 lg:grid-cols-2 lg:gap-14'>
						<div className='max-w-xl lg:max-w-none'>
							...
							<p className='mt-4 leading-relaxed text-slate-600'>
								Популярна точка поруч із Поляною: зручний під’їзд, майданчик для фото та панорами. Маршрут
								легко поєднати з відпочинком у шале або іншими локаціями дня.
							</p>
						...
						<div className='grid gap-4 sm:grid-cols-2'>
							<div className='rounded-2xl border border-slate-200/90 bg-[#F5F6F7] p-5 shadow-sm'>
								...
								<p className='mt-2 text-lg font-bold text-[#2D333D]'>{PRICE_PER_PERSON_UAH} грн / особа</p>
								<p className='mt-2 text-sm text-slate-600'>
									У машині зазвичай 4–5 осіб → орієнтовно до {CAR_PRICE_HINT_UAH} грн за авто.
								</p>
							</div>
							...
							<div className='rounded-2xl border border-slate-200/90 bg-[#F5F6F7] p-5 shadow-sm'>
								...
								<p className='mt-2 text-lg font-bold text-[#2D333D]'>1,5–2 години</p>
								<p className='mt-2 text-sm text-slate-600'>
									З урахуванням дороги та зупинок для фото (може змінюватися залежно від маршруту).
								</p>
							</div>
						</div>
						...
						<div className='mt-5 grid gap-4 sm:grid-cols-2'>
							<div className='rounded-2xl border border-slate-200/90 bg-white p-5 shadow-sm'>
								...
								<p className='mt-2 font-semibold text-[#2D333D]'>Місцевий водій / гід</p>
								<p className='mt-2 text-sm text-slate-600'>
									Супровід, підказки по точках для фото та зупинки в дорозі.
								</p>
							</div>
							<div className='rounded-2xl border border-slate-200/90 bg-white p-5 shadow-sm'>
								<p className='flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-slate-500'>
				...
				<section
					...
					aria-labelledby='rozhok-gallery-heading'
				>
					<h2 id='rozhok-gallery-heading' className='text-xl font-bold text-[#2D333D] sm:text-2xl'>
						Фото
					</h2>
					<p className='mt-2 max-w-3xl text-sm text-slate-600'>
						Декілька кадрів, щоб відчути атмосферу оглядової точки.
					</p>
					<div className='mt-6'>
						<RozhokPhotoGalleryStrip images={ROZHOK_PHOTOS} />
					</div>
				</section>
