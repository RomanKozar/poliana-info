...
import VyzhynSmallRouteMap from '@/components/excursions/VyzhynSmallRouteMap'
import {
...
export default function VyzhynSmallDetailPage() {
	return (
		<PhotoGalleryProvider images={VYZHYN_PHOTOS}>
			<div className='flex min-h-0 w-full flex-col bg-[#F5F6F7] pb-3 sm:pb-12'>
				<section className='border-b border-slate-200/80 bg-white px-4 py-8 sm:px-16 lg:py-12 lg:px-24'>
					<div className='grid items-start gap-8 lg:grid-cols-2 lg:gap-14'>
						<div className='max-w-xl lg:max-w-none'>
							...
							<h1 className='mt-2 text-3xl font-bold text-[#2D333D] sm:text-4xl'>Гора Малий Вижень</h1>
							...
							<p className='mt-4 leading-relaxed text-slate-600'>
								Компактний маршрут для тих, хто хоче відчути висоту без багатогодинного переходу. Чудові
								краєвиди на довколишні села та хребти.
							</p>
							...
							<div className='grid gap-4 sm:grid-cols-2'>
								<div className='rounded-2xl border border-slate-200/90 bg-[#F5F6F7] p-5 shadow-sm'>
									...
									<p className='mt-2 text-sm text-slate-600'>
										Вартість залежить від формату (пішки / трансфер) та кількості людей.
									</p>
								</div>
								...
								<div className='rounded-2xl border border-slate-200/90 bg-[#F5F6F7] p-5 shadow-sm'>
									...
									<p className='mt-2 text-lg font-bold text-[#2D333D]'>Орієнтовно 2–3 години</p>
									<p className='mt-2 text-sm text-slate-600'>Залежить від темпу, погоди та кількості зупинок.</p>
								</div>
							</div>
							...
							<div className='mt-5 grid gap-4 sm:grid-cols-2'>
								<div className='rounded-2xl border border-slate-200/90 bg-white p-5 shadow-sm'>
									...
									<p className='mt-2 text-sm text-slate-600'>
										Підбір темпу, безпечний маршрут і підказки по точках для фото.
									</p>
								</div>
								<div className='rounded-2xl border border-slate-200/90 bg-white p-5 shadow-sm'>
									<p className='flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-slate-500'>
				...
				<section
					...
					aria-labelledby='vyzhyn-gallery-heading'
				>
