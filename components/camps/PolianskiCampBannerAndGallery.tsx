...
type Props = {
	/** Головне фото зверху (зазвичай `polianskiCamp.image`) */
	bannerSrc: string
	/** Підпис для alt / відкриття галереї */
	bannerAlt: string
}

export default function PolianskiCampBannerAndGallery({ bannerSrc, bannerAlt }: Props) {
