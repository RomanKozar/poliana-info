/**
 * Конвертує HEIC/JPEG/PNG у WebP у public/images/excursions/tours/<slug>/.
 * Картки екскурсій - до 1200×900 (4:3), quality 82.
 */
import fs from 'fs'
...
const baseDir = path.join(root, 'public', 'images', 'excursions', 'tours')
...
async function main() {
	...
	else console.log(`done: ${count} file(s)`)
}
